...
class TestElementBox(BasePage):
    ...
    def test_all_form(self, ):
        ...
        # print(tel_number)
                # Профили
        with allure.step('Введены профили'):
        ...
        with allure.step('Загружен скан документов'):
        ...
        # self.element_is_present(self.locators.UPLOAD_FILE).send_keys(path)
        # os.remove(path)
        with allure.step('Введены паспортные данные'):
            ...
            self.element_if_visible(self.locators.NEXT4).click()
                # Военная служба
        with allure.step('Введена военная служба'):
            ...
            self.element_if_visible(self.locators.NEXT5).click()
                # Образование
        with allure.step('Введены данные образования'):
            ...
            self.element_if_visible(self.locators.NEXT6).click()
                # Работа
        with allure.step('Введены данные работы'):
        ...
        #self.element_if_visible(self.locators.K_OPITY).click()
                # Релевантный опыт
        with allure.step('Введены данные релевантного опыта'):
            ...
            self.element_if_visible(self.locators.NEXT10).click()
                # опыт 2
        with allure.step('Отмечены пункты опыта'):
            item_list_accept = self.elements_are_visible(self.locators.SPISOK_EXP_ACCEPT)
            len_item_list_accept = len(item_list_accept)
            const_count = 17
            while const_count != 0:
            ...
            self.element_if_visible(self.locators.NEXT9).click()
                # Компетенции
        with allure.step('Введены данные компетенций'):
            ...
            item_competencies.click()
                # Навыки
        with allure.step('Введены данные навыков'):
            ...
            self.element_if_visible(self.locators.NEXT9).click()
                # Summary
        with allure.step('Итоговые данные сохранены'):
        ...
        with allure.step('Итоговые данные выведены в терминал'):
            print(list_all_info)
        time.sleep(1)
